...
Sandbox.prototype._parse = function (data) {
	...
	if (json.type == "dapp_response") {
		...
		if (!callback) {
			return this._onError(new Error("Ebookcoin can't find callback_id from vm"));
		}
		...
		if (message === null || message === undefined) {
			return this._onError(new Error("Ebookcoin can't find message for request from vm"));
		}
